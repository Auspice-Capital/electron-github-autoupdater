...
var ElectronGithubAutoUpdater = /** @class */ (function (_super) {
    ...
    function ElectronGithubAutoUpdater(_a) {
        ...
        _this._downloadUpdateFromRelease = function (release) { return __awaiter(_this, void 0, void 0, function () {
            var assets, totalSize, downloaded, lastEmitPercent, downloadFile, _a, assets_1, assets_1_1, asset, e_1_1;
            var _this = this;
            var _b, e_1, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        _a = true, assets_1 = __asyncValues(assets);
                        _e.label = 2;
                    case 2: return [4 /*yield*/, assets_1.next()];
                    case 3:
                        if (!(assets_1_1 = _e.sent(), _b = assets_1_1.done, !_b)) return [3 /*break*/, 6];
                        _d = assets_1_1.value;
                        _a = false;
                        asset = _d;
                    ...
                    case 8:
                        ...
                        if (!(!_a && !_b && (_c = assets_1.return))) return [3 /*break*/, 10];
                        return [4 /*yield*/, _c.call(assets_1)];
                    case 9:
                        _e.sent();
                        _e.label = 10;
